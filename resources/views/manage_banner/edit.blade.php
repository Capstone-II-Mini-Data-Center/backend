...
@section('content')
    <div class="w-6/7 bg-white mr-10 ml-10">
        ...
        <form action="{{ route('manage_banner.update', $banner->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select name="package_id" id="package_id" class="mt-1 p-2 border rounded-md w-full">
