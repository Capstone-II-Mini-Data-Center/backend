...
@section('content')
  <div class="flex justify-between">
    ...
    <div class="w-full bg-white mr-5 ml-10 relative ">
        <div class="flex">
            <div>
                <form action="{{ route('packages.filterByPriceRange') }}" method="GET">

                </form>
            </div>
            <div class="ml-auto mr-4">
                <!-- <form id="filterByRecommendedForm" action="{{ route('packages.filterByRecommended') }}" method="GET">
                    ...
                    @foreach($packages as $index => $package)
                        <tr class="border border-2">
                            ...
                            <td class="py-2 px-4 border-b text-center flex flex-row items-center justify-center">
                                <a href="{{ route('packages.edit', $package->id) }}" class="mr-3">
