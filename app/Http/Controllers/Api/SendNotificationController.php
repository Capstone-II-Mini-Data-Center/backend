...
class SendNotificationController extends Controller
{
    public function sendNotification(Request $request)
    {
        ...
        $photo = Config("app.url_capstone")  . "/" . $order->payment_image;
        ...
        $image = Http::get("https://api.telegram.org/bot7024147212:AAGrYDUgeTfJbHns5b-9r9eunUgf8k1H90c/sendPhoto?chat_id=-4192788373&photo=" . $photo);
